...
$.fn.bic_calendar = function(options) {
    ...
    this.each(function() {
        ...
        function showCalendar() {
            ...
            var nextMonthButton = $('<td align="left" bgcolor="#F5F5F5"><a href="#" class="button-month-next"><i class="fa fa-chevron-right"></i></a></td>');
            ...
            var previousMonthButton = $('<td align="right" bgcolor="#F5F5F5"><a href="#" class="button-month-previous"><i class="fa fa-chevron-left"></i></a></td>');
            ...
            var nextYearButton = $('<td><a href="#" class="button-year-next"><i class="fa fa-chevron-right"></i></a></td>');
            ...
            var previousYearButton = $('<td><a href="#" class="button-year-previous"><i class="fa fa-chevron-left"></i></a></td>');
        ...
        function changeDate(month, year) {
            ...
            markSelectedDays();
              <%
                            set rs_eventos = conn.execute("Select * from table_calendario") 

                             If Not rs_eventos.Eof or Not rs_eventos.Bof Then

								Do While Not rs_eventos.Eof

								data_evento = cdate(rs_eventos("data"))

								data_evento = day(data_evento) & "_" & month(data_evento) & "_" & Year(data_evento)

								'set rs_marcas = conn.execute("Select * from table_marcas where id ="& rs_eventos("id_marca"))
							%>

							 $("#calendari_lateral1 #bic_calendar_<%=data_evento%> a").append("<p class='hidden-xs' style='font-size:13px;font-weight:normal'><br><%=rs_eventos("titulo")%></p>");
